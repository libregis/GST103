...
![Data Layers in QGIS Desktop](figures/Lab3/Data_Layers_in_QGIS_Desktop.png "Data Layers in QGIS Desktop")
...
5. Click Vector | Topology Checker| TopologyChecker, or, click on the Topology Checker ![Topology Checker button](figures/Lab3/Topology_Checker_button.png "Topology Checker button") button to open the Topology Checker panel (figure below).

![Topology Checker Panel](figures/Lab3/Topology_Checker_Panel.png "Topology Checker Panel")
...
![Topology Rule Setting](figures/Lab3/Topology_Rule_Setting.png "Topology Rule Setting")
...
![Topology Errors Found](figures/Lab3/Topology_Errors_Found.png "Topology Errors Found")
...
![Bus Route Topology Rule](figures/Lab3/Bus_Route_Topology_Rule.png "Bus Route Topology Rule")
...
![Parcel Topology Rules](figures/Lab3/Parcel_Topology_Rules.png "Parcel Topology Rules")
...
5. Use the Select Feature by Rectangle tool ![Select Feature by Rectangle tool](figures/Lab3/Select_Feature_by_Rectangle_tool.png "Select Feature by Rectangle tool") *and drag a small rectangle* to select the duplicate parcels on the map.
...
10. Click the Delete selected features ![Delete Selected Features Button](figures/Lab3/Delete_selected_features_button.png "Delete Selected Features Button") button to remove the duplicate parcel.
...
![Snapping Options](figures/Lab3/Snapping_Options.png "Snapping Options")
...
![Digitizing Options](figures/Lab3/Digitizing_Options.png "Digitizing Options")
...
![Overlap Area for Feature ID 624](figures/Lab3/Overlap_Area_for_Feature_ID_624.png "Overlap Area for Feature ID 624")
...
16. Use the Select Feature by Rectangle tool ![Select Feature by Rectangle tool](figures/Lab3/Select_Feature_by_rectangle_tool.png "Select Feature by Rectangle tool") to select the western (left) overlapping parcel. The vertices of the selected feature will appear as red Xs.
17. Enable the Digitizing toolbar by clicking View | Toolbars | Digitizing.
17. On the Digitizing toolbar, click on the Node tool ![Node tool](figures/Lab3/Node_tool.png "Node tool"). This tool allows you to move individual feature vertices.
...
![Selected Verticies](figures/Lab3/Selected_Vertices.png "Selected Verticies")

18. Click on the upper right vertex and the selected vertex will turn blue (figure below).

![Selected Vertex with the Node tool](figures/Lab3/Selected_vertex_with_the_Node_tool.png "Selected Vertex with the Node tool") 
...
![Overlap Resolved](figures/Lab3/Overlap_Resolved.png "Overlap Resolved")
...
![Smaller Overlap Issue](figures/Lab3/Smaller_Overlap_Issue.png "Smaller Overlap Issue")
...
![Gap Error](figures/Lab3/Gap_Error.png "Gap Error")
...
![Fixing the Gap Error](figures/Lab3/Fixing_the_Gap_Error.png "Fixing the Gap Error")
